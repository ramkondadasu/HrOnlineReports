...
/**
 * The persistent class for the HRARCHIVE_PEOPLE_VW database table.
 * 
 */
@Entity
@Immutable
@Table(schema="hrhist",name="HRARCHIVE_PEOPLE_VW")
@NamedQuery(name="HrarchivePeopleVw.findAll", query="SELECT h FROM HrarchivePeopleVw h")
public class HrarchivePeopleVw implements Serializable {
