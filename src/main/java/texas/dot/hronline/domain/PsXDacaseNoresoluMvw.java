...
/**
 * The persistent class for the PS_X_DACASE_NORESOLU_MVW database table.
 * 
 */
@Entity
@Immutable
@Table(schema="hrhist",name="PS_X_DACASE_NORESOLU_MVW")
@NamedQuery(name="PsXDacaseNoresoluMvw.findAll", query="SELECT p FROM PsXDacaseNoresoluMvw p")
public class PsXDacaseNoresoluMvw implements Serializable {
